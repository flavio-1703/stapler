import { Accordion, AccordionDetails, AccordionSummary, Container, Divider, Switch, TextField, Typography } from "@mui/material";
    ...
    return(
        <Container>
            ...
            <Accordion className="accordion">
                ...
                <AccordionSummary className="summary" expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                    <div className="accordion-header">
                        <ManageAccountsRoundedIcon className="accordion-icon" />
                ...
                <AccordionDetails className="accordion-details">
                    ...
                    <div className="holder">
                        <div className="holder-info">
                            <p className="holder-label">Name</p>
                            <Typography>Flavio Elezi</Typography>
                        </div>
                    ...
                    <div className="holder">
                        <div className="holder-info">
                            <p className="holder-label">Email</p>
                            <Typography>eleziflavio@gmail.com</Typography>
                        </div>
                        <EditRoundedIcon className="edit" />
                    </div>
                    ...
                    <div className="holder">
                        <div className="holder-info">
                            <p className="holder-label">Phone number</p>
                            <Typography>+39 380 9049752</Typography>
                        </div>
                        <EditRoundedIcon className="edit" />
                    </div>
                    ...
                    <div className="holder">
                        <div className="holder-info">
                            <p className="holder-label">Date of birth</p>
                            <Typography>17/03/1997</Typography>
                        </div>
                        <EditRoundedIcon className="edit" />
                    </div>
                    ...
                    <div className="holder">
                        <div className="holder-info">
                            <p className="holder-label">Gender</p>
                    ...
                    <div className="holder">
                        <div className="holder-info">
                            <p className="holder-label">Password</p>
            ...
            <Accordion className="accordion">
                ...
                <AccordionSummary className="summary" expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                    <div className="accordion-header">
                        <PolicyRoundedIcon className="accordion-icon" />
...
Office: 165 11th St, San Francisco, CA 94103
            ...
            <Accordion className="accordion">
                ...
                <AccordionSummary className="summary" expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
                    <div className="accordion-header">
                        <RemoveRedEyeRoundedIcon className="accordion-icon" />
                        <h4 className="title">Visual</h4>
                    </div>
                </AccordionSummary>
                ...
                <AccordionDetails className="accordion-details">
                    <div className="spanner">
                        <DarkModeRoundedIcon />
                        <div className="spanner-left">
                            <Typography>Dark Mode</Typography>
                            <p className="spanner-left-detail">This will give a dark theme.</p>
                        </div>
                    ...
                    <div className="spanner">
                        ...
                        <div className="spanner-left">
                            ...
                            <p className="spanner-left-detail">Recieve notifications.</p>
                        </div>
                        <Switch className="switch" />
                    </div>
                </AccordionDetails>
